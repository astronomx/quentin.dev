        ...
        <div className="flex flex-col lg:items-center md:flex-row w-full gap-5">
            ...
            <div className="flex flex-col gap-3 w-full md:w-7/12 lg:p-5">
                ...
                <StatCard title="Internship" content="
                    ...
                    and Plan Internationaal. Here, I learned how a project is set up from the start, a lot about of extra's working with Git, how to handle meetings 
                    and how to meet deadlines. The main thing I worked with was wordpress BUT with a twist, we used ACF Custom fields, 
                    twig and SCSS to create custom themes and block the NGO's could use all in their in own style.
                    " 
